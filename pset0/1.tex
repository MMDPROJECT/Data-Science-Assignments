...
\begin{figure}[h] % 'h' means place the figure "here"
    \centering
    \includegraphics[width=0.5\textwidth]{1.png} % adjust width and file path as needed
    \caption{Distribution of SalePrice}
\end{figure}

\begin{figure}[] % 'h' means place the figure "here"
    \centering
    \includegraphics[width=0.5\textwidth]{2.png} % adjust width and file path as needed
...
\begin{figure}[] % 'h' means place the figure "here"
    \centering
    \includegraphics[width=0.5\textwidth]{3.png} % adjust width and file path as needed
...
\begin{figure}[] % 'h' means place the figure "here"
    \centering
    \includegraphics[width=0.5\textwidth]{4.png} % adjust width and file path as needed
